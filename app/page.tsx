    ...
    <div className="max-w-5xl mx-auto px-6 py-12 space-y-20">
      ...
      <section className="space-y-6 text-center md:text-left py-10">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight leading-tight">
          ...
          <span className="text-[#C5A059]">DARK FICTION. DIEGETIC SOUND.</span>
        </h1>
      ...
      <section id="lore" className="grid md:grid-cols-3 gap-6">
        ...
        <div className="bg-[#121212] p-6 rounded-lg border border-[#222] space-y-3">
          ...
          <p className="text-sm text-gray-400">A massive, ancient aquatic terror lurking beneath the river currents, steeped in dark legend.</p>
        </div>
        <div className="bg-[#121212] p-6 rounded-lg border border-[#222] space-y-3">
          ...
          <p className="text-sm text-gray-400">The sacred river deity mark etched permanently from collarbone to wrist, signifying unbroken loyalty.</p>
        </div>
      </section>
